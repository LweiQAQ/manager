...
CREATE TABLE `check_in`  (
  `check_in_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '入住id',
  ...
  `peo_count` int(0) NOT NULL DEFAULT 1 COMMENT '入住人数',
...
CREATE TABLE `comment`  (
  ...
  `type_id` bigint(0) NULL DEFAULT NULL COMMENT '酒店id',
...
CREATE TABLE `hotel_info`  (
  `hotel_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '酒店id',
...
CREATE TABLE `order_info`  (
  `order_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '自增id',
  ...
  `room_type_id` int(0) NULL DEFAULT NULL,
  `room_type` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '房间类型',
  `num_of_room` int(0) NOT NULL DEFAULT 1 COMMENT '房间数',
  `order_date` date NOT NULL COMMENT '预订日期',
  `order_days` int(0) NOT NULL DEFAULT 1 COMMENT '预定天数',
  `order_status` int(0) NOT NULL DEFAULT 0 COMMENT '订单状态:0-已下单，1-已付款，2-已消费，-1-已取消，-2-被删除',
...
CREATE TABLE `order_type`  (
  `type_id` int(0) NOT NULL AUTO_INCREMENT COMMENT 'typeId',
...
CREATE TABLE `room_type`  (
  `type_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '类型ID',
...
CREATE TABLE `worker_info`  (
  `worker_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '操作员id',
...
-- ----------------------------
INSERT INTO `worker_info` VALUES (1, 'admin', 'admin', '4297f44b13955235245b2497399d7a93', '袁秀英', '男', '13164981755', 1, 'juan18@hotmail.com', '贵州省洁市清城汕尾街d座 502246', '2021-12-07 12:40:05', '2022-01-13 21:56:12');
INSERT INTO `worker_info` VALUES (2, 'operator', 'work1', '4297f44b13955235245b2497399d7a93', '沈璐', '男', '13873572680', 3, 'pwei@yuan.cn', '山西省合肥县西峰香港街C座 302114', '2021-12-19 12:55:13', '2022-01-13 21:56:12');
INSERT INTO `worker_info` VALUES (3, 'operator', 'work6', '4297f44b13955235245b2497399d7a93', '丁艳', '男', '18826244663', 4, 'jinggu@yongzeng.net', '西藏自治区秀荣市海陵张家港街m座 576579', '2021-12-19 12:58:09', '2022-01-13 21:56:12');
INSERT INTO `worker_info` VALUES (32, 'admin', 'work8', '4297f44b13955235245b2497399d7a93', '黄柳', '男', '15660538227', 1, 'xia53@gangjing.cn', '天津市辽阳市金平傅街j座 850761', '2022-01-04 11:53:30', '2022-01-13 21:56:12');
...
INSERT INTO `worker_info` VALUES (34, 'operator', 'work3', '4297f44b13955235245b2497399d7a93', '田龙', '女', '13658227544', 4, 'qiangfang@yahoo.com', '浙江省坤县西峰余街C座 221697', '2022-01-04 11:53:30', '2022-01-13 21:56:12');
INSERT INTO `worker_info` VALUES (35, 'operator', 'work4', '4297f44b13955235245b2497399d7a93', '徐桂香', '男', '13637320900', 2, 'fangyang@pinggang.cn', '江西省南昌县双滦王路E座 490503', '2022-01-04 11:53:30', '2022-01-13 21:56:12');
INSERT INTO `worker_info` VALUES (40, 'admin', 'work7', '4297f44b13955235245b2497399d7a93', '韩桂花', '男', '13388584730', 1, 'xliu@yahoo.com', '江西省太原市翔安刘街J座 815655', '2022-01-04 11:57:56', '2022-01-13 21:56:12');
INSERT INTO `worker_info` VALUES (45, 'admin', 'work10', '4297f44b13955235245b2497399d7a93', '方勇', '男', '15110335073', 1, 'nawu@hotmail.com', '江苏省宁县南溪王路x座 227133', '2022-01-07 17:14:24', '2022-01-13 21:56:12');
INSERT INTO `worker_info` VALUES (46, 'operator', 'work11', '4297f44b13955235245b2497399d7a93', '徐桂芝', '女', '15357876400', 3, 'gaotao@hotmail.com', '青海省长沙县山亭廖街v座 439792', '2022-01-07 17:14:24', '2022-01-13 21:56:12');
INSERT INTO `worker_info` VALUES (47, 'operator', 'work12', '4297f44b13955235245b2497399d7a93', '郭玉英', '男', '15131877702', 4, 'yong36@gmail.com', '安徽省帆市东城唐路d座 819867', '2022-01-07 17:14:24', '2022-01-13 21:56:12');
INSERT INTO `worker_info` VALUES (48, 'operator', 'work13', '4297f44b13955235245b2497399d7a93', '张波', '女', '13034769245', 1, 'ping21@zengyi.net', '广东省巢湖县和平王路V座 418151', '2022-01-07 17:14:24', '2022-01-13 21:56:12');
INSERT INTO `worker_info` VALUES (49, 'admin', 'work14', '4297f44b13955235245b2497399d7a93', '陈桂英', '男', '15278236594', 1, 'juanliu@jieming.cn', '澳门特别行政区东莞市高港关岭街Z座 113957', '2022-01-07 17:14:24', '2022-01-13 21:56:12');
...
INSERT INTO `worker_info` VALUES (51, 'operator', 'work16', '4297f44b13955235245b2497399d7a93', '王兰英', '女', '15328888611', 4, 'epan@hotmail.com', '海南省桂荣县锡山拉萨路m座 889598', '2022-01-07 17:14:24', '2022-01-13 21:56:12');
INSERT INTO `worker_info` VALUES (52, 'operator', 'work17', '4297f44b13955235245b2497399d7a93', '张丽丽', '男', '13716052290', 2, 'mingxiong@guiyingna.cn', '贵州省玉英市长寿席路j座 607847', '2022-01-07 17:14:24', '2022-01-13 21:56:12');
INSERT INTO `worker_info` VALUES (53, 'admin', 'work18', '4297f44b13955235245b2497399d7a93', '陈红', '男', '13342125691', 1, 'vzhao@la.cn', '甘肃省勇县金平合山街V座 343550', '2022-01-07 17:14:24', '2022-01-13 21:56:12');
INSERT INTO `worker_info` VALUES (54, 'admin', 'work20', '4297f44b13955235245b2497399d7a93', '范凤英', '男', '14747652210', 1, 'juan44@hotmail.com', '江西省梧州县西峰林街g座 890108', '2022-01-07 23:54:38', '2022-01-13 21:56:12');
INSERT INTO `worker_info` VALUES (55, 'operator', 'work21', '4297f44b13955235245b2497399d7a93', '张兵', '女', '15567487644', 3, 'min11@hotmail.com', '浙江省淮安市西峰周路Q座 231298', '2022-01-07 23:54:38', '2022-01-13 21:56:12');
INSERT INTO `worker_info` VALUES (56, 'operator', 'work22', '4297f44b13955235245b2497399d7a93', '黄宁', '男', '18762780051', 4, 'taozhang@hotmail.com', '河北省荆门县东丽徐路w座 733493', '2022-01-07 23:54:38', '2022-01-13 21:56:12');
INSERT INTO `worker_info` VALUES (57, 'operator', 'work23', '4297f44b13955235245b2497399d7a93', '黄荣', '女', '18663579680', 1, 'chao28@yahoo.com', '江苏省颖县黄浦吴路f座 348086', '2022-01-07 23:54:38', '2022-01-13 21:56:12');
INSERT INTO `worker_info` VALUES (58, 'admin', 'work24', '4297f44b13955235245b2497399d7a93', '周雷', '男', '13972309788', 1, 'leixiuying@lijun.cn', '宁夏回族自治区帆县山亭黄路Q座 528477', '2022-01-07 23:54:38', '2022-01-13 21:56:12');
...
INSERT INTO `worker_info` VALUES (60, 'operator', 'work26', '4297f44b13955235245b2497399d7a93', '师婷婷', '女', '15984781796', 4, 'nren@kc.cn', '西藏自治区桂珍市友好昆明街Y座 634021', '2022-01-07 23:54:38', '2022-01-13 21:56:12');
INSERT INTO `worker_info` VALUES (61, 'operator', 'work27', '4297f44b13955235245b2497399d7a93', '何燕', '男', '14715158775', 2, 'vcao@hotmail.com', '广东省莉市朝阳台北街x座 190715', '2022-01-07 23:54:38', '2022-01-13 21:56:12');
INSERT INTO `worker_info` VALUES (62, 'admin', 'work28', '4297f44b13955235245b2497399d7a93', '马淑珍', '男', '18878249984', 1, 'fgu@hotmail.com', '江西省六安县和平永安街r座 137243', '2022-01-07 23:54:38', '2022-01-13 21:56:12');
